      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Header / Brand Area */}
            <div className="bg-jg-red p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-20 h-20 bg-white rounded-2xl mx-auto flex items-center justify-center mb-6 shadow-xl">
                  <span className="text-jg-red text-3xl font-black">JG</span>
                </div>
                <h2 className="text-3xl font-black text-white tracking-tighter mb-2">UNIVERSITY</h2>
                <p className="text-white/80 text-xs font-bold uppercase tracking-[0.3em]">Excellence By Choice</p>
              </div>
            </div>
            ...
            <div className="p-12 text-center">
              ...
              >
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-gray-300">New Session 2026-27</span>
              </motion.div>
              ...
              <button className="w-full group relative py-5 rounded-2xl bg-white text-black font-bold text-lg overflow-hidden transition-all hover:scale-[1.02] active:scale-[0.98]">
